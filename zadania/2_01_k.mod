...
# Ograniczenia
o_zakup{i in produkt}: ilosc_produktow[i] <= limit_produkt[i]; # Zapewnia, że ilość każdego produktu użytego w paszy nie przekracza jego maksymalnej dostępnej ilości.
o_popyt: sum{i in produkt} ilosc_produktow[i] = popyt; 		   # Całkowita ilość użytych produktów, która musi być równa popytowi
...
data;
param popyt := 10000;
param: produkt: cena, limit_produkt :=  'Kukurydza' 	0.2 6000
									    'Ziemniaki' 	0.12 10000
									    'Soja' 			0.24 4000
									    'Maczka rybna' 	0.12 5000;
param: skladnik: limit_dolny, limit_gorny :=
									    'Witaminy' 			6 10
									    'Białko' 			6 1000000
