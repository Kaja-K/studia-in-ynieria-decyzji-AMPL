...
# Ograniczenie - Określa, że zapotrzebowanie na każdy komponent nie może przekroczyć dostępnej liczby tych komponentów. Suma iloczynów liczby jednostek komponentów potrzebnych do wytworzenia każdego wyrobu i liczby wyrobów nie może przekraczać dostępności danego komponentu.
...
param liczba_jednostek: "C1" "C2" "C3" := 	"W1" 2 1 0 
											"W2" 1 2 3 
											"W3" 3 1 1;
solve;
