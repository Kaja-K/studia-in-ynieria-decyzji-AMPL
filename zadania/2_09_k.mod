...
o_fabryk{i in fabryka}: sum{j in hurtownia} ilosc_towarow[i,j] = podaz[i]; 	
# Gwarantuje, że suma towarów dostarczonych do każdej hurtowni z wszystkich fabryk jest równa popytowi w danej hurtowni.
o_hurtowni{j in hurtownia}: sum{i in fabryka} ilosc_towarow[i,j] = popyt[j];

data;
param cena: 'H1' 'H2' 'H3' 'H4':= 'F1' 2 4 1 5 'F2' 5 1 3 3 'F3' 1 2 4 1;
param: fabryka: podaz:='F1' 200 'F2' 100 'F3' 300;
param: hurtownia: popyt:= 'H1' 250 'H2' 250 'H3' 75 'H4' 25;
