...
# Ograniczenie - Zapewnia, że dla każdego posterunku suma czasów podróży do każdej dzielnicy, spełniających warunek czasu podróży mniejszego lub równego maksymalnemu czasowi podróży, musi być większa lub równa 1, jeśli posterunek jest obecny w tej dzielnicy.
