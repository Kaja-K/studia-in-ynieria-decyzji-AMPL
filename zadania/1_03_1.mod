...
# Funkcja celu - zmaksymalizowanie zysku (koszt produkcji - przychód z sprzedaży)
maximize zysk: (8*kotlet_1 + 6*kotlet_2) - (10*indyk_1 + 8*indyk_2); 

# Ograniczenia
o_bialy: 3*indyk_1 + 1.5*indyk_2 >= 0.7*kotlet_1 + 0.5*kotlet_2;  	# Zawartość mięsa białego
o_ciemny: 2*indyk_1 + 4*indyk_2 >= 0.3*kotlet_1 + 0.5*kotlet_2;    	# Zawartość mięsa ciemnego

solve;
display zysk, indyk_1, indyk_2, kotlet_1, kotlet_2;
# Wynik: zysk = 410
# indyk_1 = 17
# indyk_2 = 0
# kotlet_1 = 50
