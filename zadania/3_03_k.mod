...
o_gracza2{j in strategie_g2}: wygrana_g1 <= sum{i in strategie_g1} strategie_mieszane_g1[i] * wypłaty[i,j]; 
# Określa, że suma prawdopodobieństw strategii gracza 1 musi być równa 1, aby były one prawidłowymi prawdopodobieństwami.
o_prawdopodobienstw: sum{i in strategie_g1} strategie_mieszane_g1[i] = 1; 

data;
set strategie_g1 := "Kamień", "Papier", "Nożyce";
set strategie_g2 := "Kamień", "Papier", "Nożyce";
param wypłaty: 		"Kamień" "Papier" "Nożyce" := "Kamień" 0 -1 1 "Papier" 1 0 -1 "Nożyce" -1 1 0;
