...
param maksymalna_liczba_godzin;										# Maksymalna liczba godzin
...
o_czy_nie_za_duzo_godzin {j in Dni}: sum{(i,j,k,l) in Grupy} Wybrane[i,j,k,l] <= maksymalna_liczba_godzin;	# Nie więcej niż maksymalna liczba godzin dziennie
