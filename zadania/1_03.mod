...
# Ograniczenia
subject to
o_white: 3*indyk_1 + 1.5*indyk_2 >= 0.7*kotlet_1 + 0.5*kotlet_2;  # Ograniczenie na zawartość mięsa białego
o_dark: 2*indyk_1 + 4*indyk_2 >= 0.3*kotlet_1 + 0.5*kotlet_2;    	# Ograniczenie na zawartość mięsa ciemnego
