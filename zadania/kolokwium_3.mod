...
# Ograniczenie - Różnica strumieni dla każdego wierzchołka, Dla każdego wierzchołka, różnica między sumą krawędzi wchodzących do wierzchołka a sumą krawędzi wychodzących z wierzchołka musi być równa różnuicy strumieni tego wierzchołka.
...
# Wynik: Użyta ścieżka to: A - B - C - D - E
end;